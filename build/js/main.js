var playBtn = document.querySelector(".bonus__main-wheel-btn"), main = document.querySelector(".bonus__main"),
    ...
    wrapper = document.querySelector(".bonus"), rotateText = document.querySelector(".bonus__main-duckCount-counter"),
    mainShip = document.querySelector(".bonus__main-ship"), triesCounter = 0, textAfterRotate = "У тебе <br> 1 спроба";
...
function doAfterFirstRotation() {
    wheel.style.transform = "rotate(1037deg)", wheel.classList.remove("reel-rotation-first"), displayPopup(popupFirst), wrapper.style.pointerEvents = "auto", overflow.style.overflow = "hidden", mainShip.classList.add("_afterRotate"), setTimeout(function () {
